...
macro_rules! graphql_newtype {
    (
            ...
            $inner: $crate::juniper::GraphQLType<S>,
        {
            ...
            fn meta<'r>(
                info: &Self::TypeInfo,
                registry: &mut $crate::juniper::Registry<'r, S>,
            ) -> $crate::juniper::meta::MetaType<'r, S>
            where
                S: 'r,
            {
            ...
            fn resolve_field(
                ...
                info: &Self::TypeInfo,
                field_name: &str,
                arguments: &$crate::juniper::Arguments<S>,
                executor: &$crate::juniper::Executor<Self::Context, S>,
            ) -> ::std::result::Result<$crate::juniper::Value<S>, $crate::juniper::FieldError<S>>
            {
                <$inner as $crate::juniper::GraphQLType<S>>::resolve_field(
            ...
            fn resolve_into_type(
                ...
                info: &Self::TypeInfo,
                type_name: &str,
                selection_set: Option<&[$crate::juniper::Selection<S>]>,
                executor: &$crate::juniper::Executor<Self::Context, S>,
            ) -> ::std::result::Result<$crate::juniper::Value<S>, $crate::juniper::FieldError<S>>
            {
                <$inner as $crate::juniper::GraphQLType<S>>::resolve_into_type(
                    &self.0,
                    info,
                    type_name,
                    selection_set,
            ...
            fn concrete_type_name(&self, context: &Self::Context, info: &Self::TypeInfo) -> String {
                <$inner as $crate::juniper::GraphQLType<S>>::concrete_type_name(
                    &self.0, context, info,
                )
            }
            ...
            fn resolve(
                ...
                selection_set: Option<&[$crate::juniper::Selection<S>]>,
                executor: &$crate::juniper::Executor<Self::Context, S>,
            ) -> $crate::juniper::Value<S> {
                <$inner as $crate::juniper::GraphQLType<S>>::resolve(
                    &self.0,
                    info,
                    selection_set,
                    executor,
        ...
        where
            $inner: $crate::juniper::FromInputValue<S>,
        {
            fn from_input_value(v: &$crate::juniper::InputValue<S>) -> Option<Self>
            where
                for<'b> &'b S: $crate::juniper::ScalarRefValue<'b>,
            {
        ...
        where
            $inner: $crate::juniper::ToInputValue<S>,
        {
